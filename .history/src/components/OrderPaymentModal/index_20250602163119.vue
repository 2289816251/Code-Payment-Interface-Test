<template>
  ...
  >
    ...
    <!-- 订单状态1 -->
    <template v-if="props.orderStatus == 1">
      <div class="content">
      ...
      <div class="paymentSuccessful">
        ...
        <div class="shopInfo">
          ...
          <div class="list">
            ...
            <span class="right">{{ props.orderdata.time }}</span>
          </div>
        </div>
      </div>
    </template>
    ...
    <!-- 支付超时 -->
    <template v-else-if="props.orderStatus == 4">
    ...
    <template v-if="props.orderStatus == 1">
      ...
      <div class="shopInfo">
        ...
        <div class="list">
          <span class="left">创建时间：</span>
          <span class="right">{{ props.orderdata. }}</span>
        </div>
      </div>
      <a-divider />
      <div class="bottom">
