<template>
  <div class="title">
    ...
    <div class="historicalOrder" @click="homeStore.OrderDataListDrawerIsShow = true">
  ...
  />
  <OrderDataListDrawer v-show="homeStore.OrderDataListDrawerIsShow" :open="homeStore.OrderDataListDrawerIsShow" :orderdata="homeStore.historicalOrderList"/>
</template>
