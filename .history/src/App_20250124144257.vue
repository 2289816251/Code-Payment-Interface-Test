<template>
  ...
  <div class="paymentMethods" v-if="formState.commodity != '' && formState.price != 0">
    <div class="item" @click="switchPaymentMethods(item)" :class="item.state ? 'active' : ''" v-for="(item,index) in paymentMethods" :key="index">
