...
import { generateSignedString, signString, getSignContent } from '@/hooks/useRSA'
...
-----END PRIVATE KEY-----`,
  ...
  actions: {
    ...
    organizingTheData(data) {
      ...
      // 生成待签名字符串
      let queryString1 = generateSignedString(result)
      // console.log(queryString1)
      let queryString2 = getSignContent(result)
      // console.log(queryString2)

      // 使用 RSA 私钥对待签名字符串进行签名
      result.sign = signString(this.privateKey, this.platformPublicKey, queryString1);
      // result.sign = queryString
